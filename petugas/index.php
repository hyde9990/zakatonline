...
$konfirmasi = mysql_query("SELECT id_pembayaran FROM pembayaran WHERE status = 'proses' AND id_petugas = 1");
...
<TABLE WIDTH=159 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		...
		<TD background="../images/r5.gif" WIDTH=31 HEIGHT=20 align="center">
			<span id="pesan"><span id="notifikasi"></span></span></TD>
		<TD>
			<A HREF="?page=beranda">
				<IMG SRC="images/r3.gif" WIDTH=31 HEIGHT=20 BORDER=0 ALT="" class="menus" title="beranda"></A></TD>
		<TD>
			<a href="proses_logout.php?logout" onClick="return confirm('apakah anda yakin?')">
				<IMG SRC="images/r6.gif" WIDTH=28 HEIGHT=20 BORDER=0 ALT="" class="menus" title="keluar"></A></TD>
		<TD>
...
<strong>Rizal</strong> (siswa)</div>
		...
		<td background="images/bg2.gif" colspan="2">        	
            <div class="arrowlistmenu">                
                ...
                <ul class="categoryitems">
                    <li class="li"><a href="?page=petugas_detail">Lihat data saya</a></li>
                </ul>
                
                <h2 class="menuheader expandable">Member</h2>
                <ul class="categoryitems">
                    <li class="li"><a href="?page=user_register">Tambah data member</a></li>
                    <li class="li"><a href="?page=user_Show"> Data Member</a></li>
                </ul>
                ...
                <ul class="categoryitems">
                    <li class="li"><a href="?page=bukutamu_show">Lihat Buku Tamu</a></li>                    
                </ul>
	...
	<TR>
				<TD COLSPAN=2 background="images/bg9.gif" WIDTH=167 HEIGHT=94 align="center"><div style="padding:20;padding-top:5;padding-right:10;padding-bottom:0;color:000000" class="tah10">selamat datang petugas <?php echo $id_user;?></div></TD>
	</TR>
	<TR>
...
<TR>
                            ...
                            <TD background="images/bg16.gif" WIDTH=847 HEIGHT=48>
  <div style="padding-top:12;color:A8A8A8" class="tah11">
                                    SMK TELKOM SANDHY PUTRA MALANG <Br>
                                    TUGAS AKHIR<a href="?page=tentang_kami" style="color:467B99" class="tah11">kel 44</a>. 5                               </div>                          </TD>                                                
          <TD background="images/bg16.gif" width="454">          </TD>
        </TR>                      
          </TABLE>                                          
<div style="padding-top:12;color:A8A8A8" class="tah11">
                                	          </TD>
