...
echo "<hr color=\"#99E2FF\" width=\"90%\" align=\"left\">";
 	while($baris = mysql_fetch_array($query)){
		...
		echo "<tr>";
		echo "<td colspan=2 align=right><a href='?page=artikel_detail&id_artikel=$id_artikel&del=$baris[0]'>
			<img src='images/delete_64.png' title='delete' width='30' height='30'></a></td>";
		echo "</tr>";
                echo "<tr>";
