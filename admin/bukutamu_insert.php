...
<html lang="en">
    <head>
        ...
        <script src="jquery/jquery-1.4.3.js"></script>
    ...
    <body>        
        <div class="demo">
            ...
            <div id="dialog-form" title="input buku tamu">
                <p class="validateTips">All form fields are required.</p>

                <form action="bukutamu_proses_isi.php" method="post">
                    <fieldset>                        
                        ...
                        <label>pesan</label>
                        <textarea name="pesan" class="text ui-widget-content ui-corner-all" cols="50" rows="5"></textarea>
            ...
            <button id="create-user">input buku tamu</button>
