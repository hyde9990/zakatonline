<h2><img src="images/man128.png" width="30" height="30"> Ubah data member
...
<div align="center">
    ...
    <form action="user_Update.php" method='get'>
        ...
        echo "<tr><td>tanggal_lahir</td><td> : </td><td><input type = text id=\"popup_container\" name = tanggal_lahir value={$data['tanggal_lahir']}><br></td></tr>";
