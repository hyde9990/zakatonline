...
<TABLE WIDTH=159 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		...
		<TD>
			<A HREF="#">
				<IMG SRC="images/r4.gif" WIDTH=29 HEIGHT=20 BORDER=0 ALT="" class="menus"></A></TD>
		<TD><IMG SRC="images/r4.gif" WIDTH=31 HEIGHT=20 BORDER=0 ALT="" class="menus">
			<A HREF="#">
				</A></TD>
		<TD>
        	<A HREF="#">
				<IMG SRC="images/r4.gif" WIDTH=31 HEIGHT=20 BORDER=0 ALT="" class="menus"></A></TD>
		<TD>
			<a href="proses_logout.php?logout" onClick="return confirm('apakah anda yakin?')">
				<IMG SRC="images/r6.gif" WIDTH=28 HEIGHT=20 BORDER=0 ALT="" title="keluar" class="menus"></A></TD>
		<TD>
	...
	<TR>
	 ...
	 <TR align="center">
                      		 <TD COLSPAN=6 background="images/img5.jpg" width="579" height="75"><a href="?page=beranda">
...
<strong>Rizal</strong> (siswa)</div>
	...
	<TR>
		<td background="images/bg2.gif" colspan="2">        	
            ...
            <h2 class="menuheader expandable">TENTANG KAMI</h2>
                ...
                <ul class="categoryitems">                    
                    <li class="li"><a href="?page=artikel_show">Lihat Artikel</a></li>
                </ul>
                
                <h2 class="menuheader expandable">pembayaran</h2>
                <ul class="categoryitems">
                    <li class="li"><a href="?page=trans_pilihan">bayarkan zakat anda</a></li>
                    <li class="li"><a href="?page=trans_konfirmasi_pembayaran">konfirmasikan pembayaran anda</a></li>
                </ul>           
                
                <h2 class="menuheader expandable">Data Saya</h2>
                <ul class="categoryitems">
                    <li class="li"><a href="?page=user_detail">Lihat data saya</a></li>
                </ul>                
            </div>
        </div>
        </td>
	...
	<TR>
		<TD COLSPAN=2 background="images/bg9.gif" WIDTH=167 HEIGHT=94 align="center"><div style="padding:20;padding-top:5;padding-right:10;padding-bottom:0;color:000000" class="tah10">selamat datang <?php echo $id_user;?></div></TD>
	</TR>
	<TR>
...
<div style="padding-left:35;padding-top:3;color:E0724A" class="tah11"></div>		</TD>
	...
	<TR>
		<TD colspan="3">
<TABLE WIDTH=1625 BORDER=0 CELLPADDING=0 CELLSPACING=0>
<TR>
                            <TD width="326"><IMG SRC="images/s7.gif" WIDTH=326 HEIGHT=48 ALT=""></TD>
                            <TD background="images/bg16.gif" WIDTH=933 HEIGHT=48>
<div style="padding-top:12;color:A8A8A8" class="tah11">
                                    SMK TELKOM SANDHY PUTRA MALANG <Br>
                                    TUGAS AKHIR<a href="?page=tentang_kami" style="color:467B99" class="tah11">kel 44</a>.
                                </div>                                                                
                          </TD>                                                
...
<map name="Map2">
  <area shape="circle" coords="29,12,29" href="#">
</map>
</BODY>
</HTML>